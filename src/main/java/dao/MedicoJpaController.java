...
public class MedicoJpaController implements Serializable {
    ...
    public Medico validar(Medico u) {
        EntityManager em = getEntityManager();
        try {
            Query query = em.createNamedQuery("Medico.validar");
            query.setParameter("ndniMedi", u.getNdniMedi());
            query.setParameter("passMedi", u.getPassMedi());
            u = (Medico) query.getSingleResult();
            return u;
        } catch (Exception e) {
            return null;
        }
    ...
    public Medico findMedicoyUsername(String username) {
        EntityManager em = getEntityManager();
        try {
    ...
    public static void main(String[] args) {
        ...
        Medico alu = aluDAO.findMedicoByDNI("75689638");
        System.out.println(alu.getNombMedi());
