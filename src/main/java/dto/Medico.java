...
@NamedQueries({
    ...
    @NamedQuery(name = "Medico.validar", query = "SELECT a FROM Medico a WHERE a.ndniMedi = :ndniMedi AND a.passMedi = :passMedi")})
public class Medico implements Serializable {
    ...
    public Medico(String logiMedi, String passMedi) {
        this.logiMedi = logiMedi;
        this.passMedi = passMedi;
    }

    public Medico(String ndniMedi, String appaMedi, String apmaMedi, String nombMedi, Date fechNaciMedi, String logiMedi, String passMedi) {
        this.ndniMedi = ndniMedi;
        this.appaMedi = appaMedi;
        this.apmaMedi = apmaMedi;
        this.nombMedi = nombMedi;
